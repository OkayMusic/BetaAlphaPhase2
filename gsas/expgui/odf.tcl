# $Id: odf.tcl 1251 2014-03-10 22:17:29Z toby $
...
proc SetODFTerms {} {
    ...
    RecordMacroEntry "phaseinfo $expgui(curPhase) ODFterms set $newterms" 0
    phaseinfo $expgui(curPhase) ODForder set $expgui(ODForder)
    RecordMacroEntry "phaseinfo $expgui(curPhase) ODForder set $expgui(ODForder)" 0
    phaseinfo $expgui(curPhase) ODFsym set $expgui(ODFsym)
    RecordMacroEntry "phaseinfo $expgui(curPhase) ODFsym set $expgui(ODFsym)" 0
	...
	phaseinfo $expgui(curPhase) ODFcoef$i set 0.
        RecordMacroEntry "phaseinfo $expgui(curPhase) ODFcoef$i set 0." 0
    }
    incr expgui(changed)
